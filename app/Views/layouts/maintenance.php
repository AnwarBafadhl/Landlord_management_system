...
<head>
    ...
    <meta name="description" content="Landlord Management System - Maintenance Panel">
    ...
    <style>
        ...
        .sidebar {
            width: 250px;
            background: linear-gradient(180deg, var(--primary-color) 10%, #dda20a 100%);
            min-height: 100vh;
        }
...
<body>
    <div id="wrapper">
        ...
        <nav class="sidebar" id="sidebar">
            <a class="sidebar-brand" href="<?= site_url('maintenance/dashboard') ?>">
                <i class="fas fa-hard-hat"></i>
                <span>Work Panel</span>
            </a>

            <hr class="sidebar-divider my-0" style="border-color: rgba(0, 0, 0, 0.15);">
            ...
            <ul class="navbar-nav">
                ...
                <!-- Divider -->
                <hr class="sidebar-divider" style="border-color: rgba(0, 0, 0, 0.15);">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="<?= site_url('maintenance/profile') ?>">
                                <i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>
                                Profile
                            </a>
                            <a class="dropdown-item" href="<?= site_url('maintenance/schedule') ?>">
                                <i class="fas fa-calendar-alt fa-sm fa-fw me-2 text-gray-400"></i>
                                Schedule
                            </a>
