                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="bank_account" 
                                           name="bank_account" 
                                           value="<?= old('bank_account', esc($user['bank_account'] ?? '')) ?>" 
                                           readonly
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="bank_name" 
                                           name="bank_name" 
                                           value="<?= old('bank_name', esc($user['bank_name'] ?? '')) ?>" 
                                           readonly
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <p class="text-muted">
                                <span class="badge badge-success"><?= ucfirst($user['role'] ?? 'landlord') ?></span>
                            </p>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <h4 class="text-success"><?= $stats['total_properties'] ?? 0 ?></h4>
                            <small class="text-muted">Properties</small>
                        </div>
                        <div class="col-6 mb-3">
                            <h4 class="text-info"><?= $stats['total_tenants'] ?? 0 ?></h4>
                            <small class="text-muted">Tenants</small>
                        </div>
                    </div>
                    <div class="row text-center">
                        <div class="col-6 mb-3">
                            <h4 class="text-warning"><?= $stats['total_income'] ?? '$0' ?></h4>
                            <small class="text-muted">Total Income</small>
                        </div>
                        <div class="col-6 mb-3">
                            <h4 class="text-primary"><?= round($stats['avg_occupancy'] ?? 0, 1) ?>%</h4>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="<?= site_url('landlord/dashboard') ?>" class="btn btn-outline-primary">
                            <i class="fas fa-home"></i> Go to Dashboard
                        </a>
                        <a href="<?= site_url('landlord/properties') ?>" class="btn btn-outline-success">
                            <i class="fas fa-building"></i> Manage Properties
                        </a>
                        <a href="<?= site_url('landlord/tenants') ?>" class="btn btn-outline-info">
                            <i class="fas fa-users"></i> Manage Tenants
                        </a>
                        <a href="<?= site_url('landlord/payments') ?>" class="btn btn-outline-warning">
                            <i class="fas fa-credit-card"></i> View Payments
                        </a>
                        <a href="<?= site_url('landlord/maintenance') ?>" class="btn btn-outline-secondary">
                            <i class="fas fa-tools"></i> Maintenance Requests
                        </a>
                        <a href="<?= site_url('landlord/reports') ?>" class="btn btn-outline-dark">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-2">
                            <i class="fas fa-check text-success"></i>
                            Keep bank details secure and updated
                        </li>
                        <li class="mb-0">
                            <i class="fas fa-check text-success"></i>
...
function enableEdit() {
    ...
    const fields = ['first_name', 'last_name', 'phone', 'address', 'bank_account', 'bank_name'];
