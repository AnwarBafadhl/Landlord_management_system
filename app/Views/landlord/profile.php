...
<div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="first_name" name="first_name"
                                ...
                                value="<?= old('first_name', esc($user['first_name'] ?? '')) ?>" readonly required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="last_name" name="last_name"
                                ...
                                value="<?= old('last_name', esc($user['last_name'] ?? '')) ?>" readonly required>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email" autocomplete="email"
                                    value="<?= old('email', esc($user['email'] ?? '')) ?>" readonly required>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" autocomplete="tel"
                                    value="<?= old('phone', esc($user['phone'] ?? '')) ?>" readonly
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3"
                                autocomplete="street-address" readonly
                ...
                <div class="card-body">
                    <div class="text-center mb-4">
                        <div class="avatar-circle mx-auto mb-3"
                            style="width: 100px; height: 100px; background: linear-gradient(135deg, #4e73df 0%, #224abe 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 0.25rem 0.5rem rgba(0, 0, 0, 0.1);">
                        ...
                        <h5 class="font-weight-bold"><?= esc($user['first_name'] ?? 'Unknown') ?>
                            <?= esc($user['last_name'] ?? 'User') ?>
                        </h5>
                    ...
                    <div class="row text-center mb-3">
                        ...
                        <div class="col-6">
                            <div class="info-item">
                                ...
                                <p class="mb-0">
                                    <span
                                        class="badge badge-<?= ($user['status'] ?? 'active') === 'active' ? 'success' : 'warning' ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-info">
                        ...
                        <strong>Security Tip:</strong> Use a strong password with at least 8 characters, including
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control" id="modal_current_password"
                                name="current_password" autocomplete="current-password" required>
                            <button class="btn btn-outline-secondary" type="button"
                                onclick="togglePassword('modal_current_password')">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-secondary" type="button"
                                onclick="togglePassword('modal_new_password')">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-secondary" type="button"
                                onclick="togglePassword('modal_confirm_password')">
    ...
    <script>
        ...
        function enableEdit() {
            ...
            showNotification('Edit mode enabled! Make your changes and click Save Changes.', 'info');
        }
        ...
        // Fixed saveProfile function with proper CSRF handling and single success message
        function saveProfile() {
            ...
            // IMPORTANT: Explicitly get CSRF token and ensure it's included
            const csrfTokenElement = form.querySelector('input[name^="csrf_"]');
            if (csrfTokenElement) {
                const csrfName = csrfTokenElement.name;
                const csrfValue = csrfTokenElement.value;
                formData.set(csrfName, csrfValue);
                console.log('CSRF Token found:', csrfName, '=', csrfValue); // Debug
            } else {
            ...
            fetch('<?= site_url('landlord/profile/update') ?>', {
                ...
                .then(data => {
                    if (data.success) {
                        // Single success message - no reload
                        showNotification('Profile updated successfully!', 'success');

                        // Exit edit mode without reloading
                        editMode = false;
                        ...
                        fields.forEach(field => {
                            ...
                            if (element) {
                                ...
                                element.classList.remove('border-primary', 'shadow-sm', 'border-success');
                            }
                        });

                        // Hide form buttons and show main edit button
        ...
        // Handle regular form submission (when not using AJAX)
        document.getElementById('profileForm').addEventListener('submit', function (e) {
            // Only prevent default if we're in edit mode (using AJAX)
            if (editMode) {
                e.preventDefault();
                saveProfile();
            }
            // If not in edit mode, let the form submit normally
        });
    ...
    `;
        ...
        // Fixed change password form submission with proper CSRF handling
        document.getElementById('changePasswordForm').addEventListener('submit', function (e) {
            ...
            // IMPORTANT: Explicitly get CSRF token for password change form
            const csrfTokenElement = form.querySelector('input[name^="csrf_"]');
            if (csrfTokenElement) {
                const csrfName = csrfTokenElement.name;
                const csrfValue = csrfTokenElement.value;
                formData.set(csrfName, csrfValue);
                console.log('Password Change CSRF Token:', csrfName, '=', csrfValue); // Debug
            } else {
                console.error('CSRF token not found in password change form');
                showNotification('Security token not found. Please refresh the page.', 'error');
                return;
            }
