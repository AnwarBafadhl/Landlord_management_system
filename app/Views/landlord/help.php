            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <strong>Quick Response:</strong> We typically respond to messages within 24 hours during business days. For urgent matters, please select "High" priority.
                    </div>
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse1" class="accordion-collapse collapse" aria-labelledby="faq1" 
                                ...
                                <div class="accordion-body">
                                    Go to <strong>Properties</strong> → <strong>Add New Property</strong>. Fill in all required information including property details, ownership percentages, and management information. The system will automatically calculate rent distributions based on ownership percentages.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="faq2" 
                                 data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Visit the <strong>Tenants</strong> section to view all your tenants. You can see lease details, payment history, and contact information.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="faq3" 
                                 data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    The system automatically tracks all payments and calculates your share based on ownership percentages. You can view payment history, generate reports, and export financial data from the <strong>Payments</strong> and <strong>Reports</strong> sections.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="faq4" 
                                 data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    All maintenance requests from tenants appear in your <strong>Maintenance</strong> dashboard. You can review requests, assign priorities, and track progress through the platform.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="faq5" 
                                 data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    The <strong>Reports</strong> section provides comprehensive financial reports, occupancy analytics, maintenance cost summaries, and custom date range reports. You can export all reports to PDF formats.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <div class="status-item d-flex justify-content-between align-items-center mb-2">
                        <span><i class="fas fa-circle text-success me-2"></i>Platform Status</span>
                        <span class="badge bg-success">Operational</span>
                    </div>
                    <div class="status-item d-flex justify-content-between align-items-center mb-2">
                        <span><i class="fas fa-circle text-success me-2"></i>Payment System</span>
                        <span class="badge bg-success">Operational</span>
                    </div>
                    <div class="status-item d-flex justify-content-between align-items-center mb-2">
                        <span><i class="fas fa-circle text-success me-2"></i>Notifications</span>
                        <span class="badge bg-success">Operational</span>
                    </div>
                    <div class="status-item d-flex justify-content-between align-items-center">
                        <span><i class="fas fa-circle text-warning me-2"></i>Maintenance</span>
